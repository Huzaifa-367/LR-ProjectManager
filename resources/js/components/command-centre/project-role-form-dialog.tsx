...
type ProjectRoleFormDialogProps = {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="flex max-h-[min(90vh,42rem)] flex-col gap-0 overflow-hidden p-0 sm:max-w-2xl">
                {open && (
                    <Form
                        {...ProjectRoleController.store.form([
                            organizationId,
                            projectId,
                        ])}
                            ...
                            <>
                                <DialogHeader className="shrink-0 space-y-1 border-b px-6 py-4">
                                    ...
                                    <DialogDescription className="text-sm">
                                        Custom roles can be assigned on the
                                        project team with tailored permissions.
                                    </DialogDescription>
                                </DialogHeader>
                                <DialogBody className="space-y-6 py-5">
                                    <div className="grid gap-2">
                                        <Label htmlFor="project-role-name">
                                            Role name
                                        </Label>
                                        <Input
